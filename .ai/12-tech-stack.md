...
- Vitest for unit and integration tests with fast execution and modern features.
- React Testing Library for component testing with user-centric testing approach.
- Playwright for end-to-end testing with multi-browser support (Chrome, Firefox, Edge, Safari).
- Supertest for API endpoint testing of Astro API routes.
- OWASP ZAP for security scanning and vulnerability detection.
- axe DevTools for accessibility testing to ensure WCAG compliance.

  ...
  const messages: ChatMessage[] = [
    {
      role: 'user',
      content:
        'Analyze this tournament: Average 85, Checkout 35%, 3x 180s, Best leg 12 darts',
    },
  ];
  ...
  const messages: ChatMessage[] = [
    {
      role: 'system',
      content:
        'You are a supportive darts coach providing constructive feedback.',
    },
    {
      role: 'user',
...
export async function modelOverrideExample() {
  ...
  const messages: ChatMessage[] = [
    { role: 'user', content: 'Write a creative darts tournament name.' },
  ];
...
export async function updateDefaultsExample() {
  ...
  const messages: ChatMessage[] = [
    { role: 'user', content: 'Analyze my darts game.' },
  ];
